...
public class UnfinishedReport extends FragmentActivity {
	...
	//creates layout for uncompleted report and allows user to still edit report
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.unfinished_report);
	...
	//method that saves currently filled in information and goes to android gallery
	public void choose (View view) {
		...
		editor.putString("whichOne", "unfinished");
		editor.commit();
